    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-xl shadow-2xl p-8">
        ...
        <div className="grid grid-cols-2 gap-6 px-4 py-8 sm:px-8">
          <Link
            to="manage"
            className="p-6 bg-blue-600 text-white flex flex-col justify-center items-center text-center rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300"
          >
