  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 via-gray-100 to-blue-50 flex items-center justify-center py-12 px-6 lg:px-8">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-xl p-8">
        <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">Add New Student</h3>

        <form className="space-y-6" onSubmit={handleSubmit}>
          {/* Student Name */}
          <div>
            <label htmlFor="student-name" className="block text-lg font-medium text-gray-700">
              Student Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="fatherName" className="block text-lg font-medium text-gray-700">
              Father Name
            </label>
            <input
              type="text"
